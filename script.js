...
// Solicita al usuario que ingrese el primer número y lo convierte en número punto flotante
var numero1 = parseFloat(prompt("Por favor ingresa un núnero del 0 al infinito"));
